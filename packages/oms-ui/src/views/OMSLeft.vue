<template>
  <Flex column backgroundColor="white" width="14%">
    <Flex column :pv="1" :ph="2">
      ...
      <Flex row :mt="1">
        <input type="text" placeholder="Filter" class="oms-left-search" />
      </Flex>
    </Flex>
        ...
        <Flex row :pv="1" :bb="1">
          <Button :onPress="() => toggleExpanded(historicTabGroup.date)">
            <Photo
              ...
              :size="1"
              :mr="1"
              v-bind:class="{'oms-left-history-collapsed': !expanded.includes(historicTabGroup.date)}"
            />
